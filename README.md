...
Two months of incremental work consolidated. **21 bugs fixed**, **262 tests** (213 unit + 49 live MCP integration), **Windows + Linux verified**. Backwards compatible — legacy `zpl_u_<48hex>` keys still work, all 69 tools keep the same input shape.
